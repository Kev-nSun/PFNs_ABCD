...
output_dir = homedir + '/Weight_Haufe_Nulls_{0}_{1}'.format(dirdate,jobID)
feature_path = '{0}/features_{1}.npy'.format(tmpdir,network)
phenotype_path = '{0}/phenotypes_target.csv'.format(tmpdir)
pred_path_dir = homedir + '/results_matchedsamples_null_1000_031424' + jobID

"""
this does the actual ridge regression
"""
print('python {0}/Weight_haufeAAB_cov_nulls_1000.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,pred_path_dir))
os.system('python {0}/Weight_haufeAAB_cov_nulls_1000.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,pred_path_dir))
