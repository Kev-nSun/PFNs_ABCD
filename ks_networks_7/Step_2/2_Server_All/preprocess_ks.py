...
Need to update data_path and make sure data_for_ridge_ks_psych_all.csv in the current running directory
"""
...
"""
phenotypes = pd.read_csv('./data_for_ridge_pfac_BASELINE.csv') #load
