...
python predict_matchedsamples_pooled.py results_matchedsamples_050224/ tempfiles_matchedsamples_031324/features_all.npy tempfiles_matchedsamples_031324/phenotypes_target.csv General_PB1 tempfiles_matchedsamples_031324/phenotypes_control.csv

"""

output_dir = sys.argv[1] #'homedir/results_matchedsamples_111122/0_network/'
os.makedirs(output_dir,exist_ok=True)
feature_path = sys.argv[2]  #'homedir/tempfiles_matchedsamples_111122/features_0.npy'
phenotype_path = sys.argv[3] #'homedir/tempfiles_matchedsamples_111122/phenotypes_target.csv'
phenotype_name = sys.argv[4] #'General_PB1'
control_path = sys.argv[5] #'homedir/tempfiles_matchedsamples_111122/phenotypes_control.csv'
