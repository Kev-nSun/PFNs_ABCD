...
folds = 100
output_dir = sys.argv[1] #'homedir/results_matchedsamples_null_111122/all_network/'
os.makedirs(output_dir,exist_ok=True)
feature_path = sys.argv[2]  #'homedir/tempfiles_matchedsamples_111122/features_all.npy'
