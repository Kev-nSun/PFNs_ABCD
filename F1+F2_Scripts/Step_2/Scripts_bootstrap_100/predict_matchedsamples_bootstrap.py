...
folds = 100
output_dir = sys.argv[1] #'homedir/results_matchedsamples_boot_mmddyy/all_network/'
os.makedirs(output_dir,exist_ok=True)
feature_path = sys.argv[2]  #'homedir/tempfiles_matchedsamples_040524/features_all.npy'
phenotype_path = sys.argv[3] #'homedir/tempfiles_matchedsamples_040524/phenotypes_target.csv'
phenotype_name = sys.argv[4] #'PRS_1'
control_path = sys.argv[5] #'homedir/tempfiles_matchedsamples_040524/phenotypes_control.csv'
...
np.save('{0}/{1}_acc_boot.npy'.format(output_dir,phenotype_name),accuracy_boot)
