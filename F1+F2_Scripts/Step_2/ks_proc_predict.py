...
output_dir = homedir + '/results_matchedsamples_{0}/{1}_network/'.format(dirdate,network)
...
"""
print('python {0}/predict_matchedsamples.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,control_path))
os.system('python {0}/predict_matchedsamples.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,control_path))
