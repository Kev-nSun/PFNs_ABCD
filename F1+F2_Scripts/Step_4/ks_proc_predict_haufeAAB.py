...
output_dir = homedir + '/Weight_Haufe_{0}'.format(dirdate)
feature_path = '{0}/features_{1}.npy'.format(tmpdir,network)
phenotype_path = '{0}/phenotypes_target.csv'.format(tmpdir)
pred_path_dir = homedir + '/results_matchedsamples_040524/'

"""
this does the actual Haufe calculation
"""
print('python {0}/Weight_haufeAAB.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,pred_path_dir))
os.system('python {0}/Weight_haufeAAB.py {1} {2} {3} {4} {5} rel_family_id'.format(homedir,output_dir,feature_path,phenotype_path,phenotype_name,pred_path_dir))
